...
peripheral targets equally spaced around the circumference of a
circle. Each target was presented in random order, and movements to
each of the 8 targets were repeated 5 times.
...
For those of you interested in programming in C, here is a C version
of the plate method code, and an example program:
